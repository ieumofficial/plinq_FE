...
export default function Header() {
  return (
    <header
      style={drag}
      className="fixed top-0 left-0 right-0 h-[103px] bg-[#efeff0] border-2 border-[#afb1b6] rounded-lg overflow-hidden z-10"
      data-name="Header"
    >
      ...
      <div className="absolute right-[13px] top-0 h-[103px] flex items-center">
        <button
          type="button"
          style={noDrag}
          className="mr-[19px] flex items-center justify-center gap-[10px] bg-black text-white rounded-[16px] px-[20px] py-[16px] overflow-hidden cursor-pointer"
        >
