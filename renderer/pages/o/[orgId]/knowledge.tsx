...
export default function OrgKnowledgePage() {
  ...
  return (
    <>
      <Head>
        <title>plinq · Organization · Knowledge / Governance</title>
      </Head>
      <OrganizationAppShell orgId={orgId} active="knowledge">
        <div className="p-6 flex flex-col gap-[10px]">
          <h1 className="text-black text-[28px] font-semibold">Knowledge / Governance</h1>
